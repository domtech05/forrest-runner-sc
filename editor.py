...
from scripts.utils import bulkImageLoad
...
class Editor:
    def __init__(self):
        ...
        self.assets = {
            ...
            'large_decor': bulkImageLoad('tiles/largeDecor'),
    ...
    def run(self):
        while True:
            ...
            if self.ongrid:
                self.display.blit(current_tile_img, (tile_pos[0] * self.tilemap.tileSize - self.scroll[0],
